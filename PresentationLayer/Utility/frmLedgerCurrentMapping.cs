...
namespace CashFlow 
{
    public partial class frmLedgerCodeCurrentMapping : Form
    {
        CashFlowBL CF = new CashFlowBL();
        public frmLedgerCodeCurrentMapping()
        {
            InitializeComponent();
        }
        ...
        private void frmLedgerCodeCurrentMapping_Load(object sender, EventArgs e)
        {
            ...
            DataSet dsLedgerCurrentMapping = CF.FetchCurrentLedgerCashFlowMapping();
